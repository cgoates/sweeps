...
vol_ii = build_solid( 21, 22, 42, 40, '1.5*(0.5*(coordsX*iHat+coordsZ*kHat)/(sqrt(coordsX^2+coordsZ^2))+sqrt(3)/2*jHat)', vol_ii )
vol_ii = build_solid( 32, 40, 43, 31, '1.5*(sqrt(3)/2*(coordsX*iHat+coordsZ*kHat)/(sqrt(coordsX^2+coordsZ^2))+0.5*jHat)', vol_ii )

vol_ii = build_solid( 30, 31, 44, 29, '1.5*(coordsX*iHat+coordsZ*kHat)/(sqrt(coordsX^2+coordsZ^2))', vol_ii )
...
vol_ii = build_solid( 35, 36, 37, 50, '-1.5*jHat', vol_ii )

vol_ii = build_solid( 56, 39, 38, 37, '1.5*(-0.5*(coordsX*iHat+coordsZ*kHat)/(sqrt(coordsX^2+coordsZ^2))-sqrt(3)/2*jHat)', vol_ii )
vol_ii = build_solid( 8, 9, 39, 54, '1.5*(-sqrt(3)/2*(coordsX*iHat+coordsZ*kHat)/(sqrt(coordsX^2+coordsZ^2))-0.5*jHat)', vol_ii )

vol_ii = build_solid( 9, 17, 18, 47, '-1.5*(coordsX*iHat+coordsZ*kHat)/(sqrt(coordsX^2+coordsZ^2))', vol_ii )

vol_ii = build_solid( 18, 46, 2, 1, '1.5*(-sqrt(3)/2*(coordsX*iHat+coordsZ*kHat)/(sqrt(coordsX^2+coordsZ^2))+0.5*jHat)', vol_ii )
vol_ii = build_solid( 2, 45, 14, 3, '1.5*(-0.5*(coordsX*iHat+coordsZ*kHat)/(sqrt(coordsX^2+coordsZ^2))+sqrt(3)/2*jHat)', vol_ii )
...
vol_ii = build_solid( 11, 15, 23, 51, '0.5*jHat', vol_ii )
vol_ii = build_solid( 23, 19, 27, 53, '0.5*(coordsX*iHat+coordsZ*kHat)/(sqrt(coordsX^2+coordsZ^2))', vol_ii )
vol_ii = build_solid( 6, 10, 27, 55, '-0.5*jHat', vol_ii )
